...
.btn {
  ...
  .btn:not(:disabled):not(.disabled):active, .btn:not(:disabled):not(.disabled).active {
    ...
    .btn:not(:disabled):not(.disabled):active:focus, .btn:not(:disabled):not(.disabled).active:focus {
      box-shadow: 0 0 0 0.2rem rgba(108, 117, 125, 0.25), inset 0 3px 5px rgba(0, 0, 0, 0.125); }
...
.custom-select {
  ...
  .custom-select:focus {
    border-color: #afb5ba;
    outline: 0;
    box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(175, 181, 186, 0.5); }
...
.custom-range {
  ...
  .custom-range::-webkit-slider-thumb {
    ...
    .custom-range::-webkit-slider-thumb:active {
      background: #caced1 linear-gradient(180deg, #d2d5d8, #caced1) repeat-x; }
